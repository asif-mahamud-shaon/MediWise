        ...
        "Home.useEffect": ()=>{
            if (!loading) {
                if (user) {
                    ...
                    const route = user.role === 'admin' ? '/admin/dashboard' : user.role === 'patient' ? '/patient/dashboard' : user.role === 'doctor' ? '/doctor/dashboard' : '/dashboard';
                    router.push(route);
                } else {
                    router.push('/login');
                }
...
//# sourceMappingURL=OneDrive_Desktop_mediwise_frontend_7a76f1dd._.js.map