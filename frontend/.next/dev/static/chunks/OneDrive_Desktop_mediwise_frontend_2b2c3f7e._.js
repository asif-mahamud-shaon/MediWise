...
"[project]/OneDrive/Desktop/mediwise/frontend/app/patient/chat/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PatientChatPage() {
    ...
    const scrollToBottom = (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PatientChatPage.useCallback[scrollToBottom]": ()=>{
            messagesEndRef.current?.scrollIntoView({
                behavior: 'smooth'
            });
        }
    }["PatientChatPage.useCallback[scrollToBottom]"], []);
    const fetchChatUsers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PatientChatPage.useCallback[fetchChatUsers]": async ()=>{
            try {
                ...
                const users = (response.data.users || []).filter({
                    "PatientChatPage.useCallback[fetchChatUsers].users": (u)=>u.role === 'doctor' || u.role === 'admin'
                }["PatientChatPage.useCallback[fetchChatUsers].users"]);
                setAllUsers(users);
            } catch (error) {
                console.error('Error fetching chat users:', error);
            }
        }
    }["PatientChatPage.useCallback[fetchChatUsers]"], []);
    const fetchConversations = (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PatientChatPage.useCallback[fetchConversations]": async ()=>{
            try {
                ...
                console.log('📋 Conversations data:', newConversations.map({
                    "PatientChatPage.useCallback[fetchConversations]": (c)=>({
                            id: c.id,
                            name: c.name,
                ...
                }["PatientChatPage.useCallback[fetchConversations]"]));
                // Sort conversations by lastMessageTime (newest first) before setting
                const sortedConversations = [
                    ...newConversations
                ].sort({
                    "PatientChatPage.useCallback[fetchConversations].sortedConversations": (a, b)=>{
                        // Get timestamps, handling null/undefined properly
                        const timeA = a.lastMessageTime ? new Date(a.lastMessageTime).getTime() || 0 : 0;
                        const timeB = b.lastMessageTime ? new Date(b.lastMessageTime).getTime() || 0 : 0;
                ...
                }["PatientChatPage.useCallback[fetchConversations].sortedConversations"]);
                // Log sorted conversations for debugging
                console.log('📊 Sorted conversations (newest first):', sortedConversations.map({
                    "PatientChatPage.useCallback[fetchConversations]": (c)=>({
                            name: c.name,
                            lastMessageTime: c.lastMessageTime,
                            timestamp: c.lastMessageTime ? new Date(c.lastMessageTime).getTime() : 0,
                            timeAgo: c.lastMessageTime ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$date$2d$fns$2f$formatDistanceToNow$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDistanceToNow"])(new Date(c.lastMessageTime), {
                                addSuffix: true
                            }) : 'N/A'
                        })
                }["PatientChatPage.useCallback[fetchConversations]"]));
                ...
                if (conversations.length > 0) {
                    const newIds = new Set(newConversations.map({
                        "PatientChatPage.useCallback[fetchConversations]": (c)=>c.id
                    }["PatientChatPage.useCallback[fetchConversations]"]));
                    const oldIds = new Set(conversations.map({
                        "PatientChatPage.useCallback[fetchConversations]": (c)=>c.id
                    }["PatientChatPage.useCallback[fetchConversations]"]));
                    const added = newConversations.filter({
                        "PatientChatPage.useCallback[fetchConversations].added": (c)=>!oldIds.has(c.id)
                    }["PatientChatPage.useCallback[fetchConversations].added"]);
                    if (added.length > 0) {
                        console.log('🆕 New conversations added:', added.map({
                            "PatientChatPage.useCallback[fetchConversations]": (c)=>c.name
                        }["PatientChatPage.useCallback[fetchConversations]"]));
                    }
                }
            } catch (error) {
    ...
    }["PatientChatPage.useCallback[fetchConversations]"], []); // Remove conversations dependency to avoid infinite loop
    const fetchMessages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PatientChatPage.useCallback[fetchMessages]": async (userId, preserveTempMessages = false)=>{
            try {
                ...
                console.log('📨 Messages data:', fetchedMessages.map({
                    "PatientChatPage.useCallback[fetchMessages]": (m)=>({
                            id: m.id,
                ...
                }["PatientChatPage.useCallback[fetchMessages]"]));
                if (preserveTempMessages) {
                    // Keep temporary messages that haven't been saved yet
                    setMessages({
                        "PatientChatPage.useCallback[fetchMessages]": (prev)=>{
                            const tempMessages = prev.filter({
                                "PatientChatPage.useCallback[fetchMessages].tempMessages": (msg)=>msg.id.startsWith('temp-')
                            }["PatientChatPage.useCallback[fetchMessages].tempMessages"]);
                            const realMessageIds = new Set(fetchedMessages.map({
                                "PatientChatPage.useCallback[fetchMessages]": (m)=>m.id
                            }["PatientChatPage.useCallback[fetchMessages]"]));
                            const tempToKeep = tempMessages.filter({
                                "PatientChatPage.useCallback[fetchMessages].tempToKeep": (msg)=>{
                                    // Keep temp message if we don't have a real message with same content yet
                                    return !fetchedMessages.some({
                                        "PatientChatPage.useCallback[fetchMessages].tempToKeep": (m)=>m.content === msg.content && m.senderId === msg.senderId && Math.abs(new Date(m.createdAt).getTime() - new Date(msg.createdAt).getTime()) < 5000
                                    }["PatientChatPage.useCallback[fetchMessages].tempToKeep"]);
                                }
                            }["PatientChatPage.useCallback[fetchMessages].tempToKeep"]);
                            const combined = [
                                ...fetchedMessages,
                                ...
                                "PatientChatPage.useCallback[fetchMessages].combined": (a, b)=>new Date(a.createdAt).getTime() - new Date(b.createdAt).getTime()
                            }["PatientChatPage.useCallback[fetchMessages].combined"]);
                ...
                setTimeout({
                    "PatientChatPage.useCallback[fetchMessages]": ()=>scrollToBottom()
                }["PatientChatPage.useCallback[fetchMessages]"], 150);
            } catch (error) {
    ...
    const fetchUnreadCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PatientChatPage.useCallback[fetchUnreadCount]": async ()=>{
            try {
    ...
    }["PatientChatPage.useCallback[fetchUnreadCount]"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PatientChatPage.useEffect": ()=>{
        ...
        "PatientChatPage.useEffect": ()=>{
            if (selectedConversation && conversations.length > 0) {
                const updated = conversations.find({
                    "PatientChatPage.useEffect.updated": (c)=>c.id === selectedConversation.id
                }["PatientChatPage.useEffect.updated"]);
                if (updated) {
                    ...
                    if (hasNewMessage || hasNewUnread || hasNewTime) {
                        ...
                        }["PatientChatPage.useEffect"]).catch({
                            "PatientChatPage.useEffect": (err)=>{
        ...
        "PatientChatPage.useEffect": ()=>{
            if (user && user.role === 'patient') {
                ...
                const globalPollInterval = setInterval({
                    "PatientChatPage.useEffect.globalPollInterval": ()=>{
                        ...
                        if (selectedConversation?.id) {
                            ...
                            }["PatientChatPage.useEffect.globalPollInterval"]).catch({
                                "PatientChatPage.useEffect.globalPollInterval": (err)=>{
                ...
                }["PatientChatPage.useEffect.globalPollInterval"], 2000); // Reduced to 2 seconds for better real-time experience
                return ({
                    "PatientChatPage.useEffect": ()=>{
    ...
    const handleSelectConversation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PatientChatPage.useCallback[handleSelectConversation]": (conversation)=>{
            setSelectedConversation(conversation);
            fetchMessages(conversation.id);
            setSearchQuery('');
            setShowSuggestions(false);
        }
    }["PatientChatPage.useCallback[handleSelectConversation]"], [
        fetchMessages
    ]);
    const handleSelectUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PatientChatPage.useCallback[handleSelectUser]": (user)=>{
            const existingConversation = conversations.find({
                "PatientChatPage.useCallback[handleSelectUser].existingConversation": (c)=>c.id === user.id
            }["PatientChatPage.useCallback[handleSelectUser].existingConversation"]);
    ...
    }["PatientChatPage.useCallback[handleSelectUser]"], [
        conversations,
        handleSelectConversation,
        fetchMessages
    ]);
    // Memoize filtered users to avoid recalculating on every render
    const filteredUsers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PatientChatPage.useMemo[filteredUsers]": ()=>{
            if (!searchQuery.trim()) return [];
            const query = searchQuery.toLowerCase();
            return allUsers.filter({
                "PatientChatPage.useMemo[filteredUsers]": (user)=>user.name.toLowerCase().includes(query) || user.email.toLowerCase().includes(query)
            }["PatientChatPage.useMemo[filteredUsers]"]);
        }
    }["PatientChatPage.useMemo[filteredUsers]"], [
        allUsers,
    ...
    const handleSendMessage = async (e)=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/chat/send', {
                receiverId: selectedConversation.id,
                content: messageContent
            });
    ...
    if (authLoading || loading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$components$2f$Loading$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
            fileName: "[project]/OneDrive/Desktop/mediwise/frontend/app/patient/chat/page.tsx",
            lineNumber: 390,
            columnNumber: 12
        }, this);
    }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                className: "w-full lg:ml-64 flex-1 transition-all duration-300 flex flex-col h-screen",
                children: [
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: "Chat with doctors and get support"
                                            }, void 0, false, {
                                                fileName: "[project]/OneDrive/Desktop/mediwise/frontend/app/patient/chat/page.tsx",
                                                lineNumber: 407,
                                                columnNumber: 17
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            unreadCount > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "px-4 py-2 bg-red-500 text-white rounded-xl font-bold shadow-lg",
                                                children: [
                                                    unreadCount,
                                                    " New"
                                                ]
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "w-12 h-12 rounded-xl bg-white text-teal-600 flex items-center justify-center font-bold shadow-lg ring-2 ring-white ring-opacity-50",
                                                children: getInitials(user?.name || 'P')
                                            }, void 0, false, {
                                                fileName: "[project]/OneDrive/Desktop/mediwise/frontend/app/patient/chat/page.tsx",
                                                lineNumber: 415,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "w-full lg:w-1/3 border-r-0 lg:border-r-2 border-gray-200 bg-white flex flex-col",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "p-4 sm:p-6 border-b-2 border-gray-200 bg-gray-50",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                                ...
                                                children: [
                                                    ...
                                                    "Conversations ",
                                                    unreadCount > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    showSuggestions && filteredUsers.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: filteredUsers.slice(0, 5).map((user)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                onMouseDown: (e)=>{
                                                                    e.preventDefault();
                                                                ...
                                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: [
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                            className: "w-10 h-10 rounded-full bg-teal-100 flex items-center justify-center text-teal-600 font-bold text-sm",
                                                                        ...
                                                                        user.unreadCount > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: (()=>{
                                            ...
                                            const allItems = [];
                                            const conversationIds = new Set(sortedConversations.map((c)=>c.id));
                                            ...
                                            console.log('📋 Final sorted conversation list:', finalSortedItems.filter((item)=>item.isConversation).map((item)=>({
                                                    name: item.name,
                                                    lastMessageTime: item.lastMessageTime,
                                                    timestamp: item.lastMessageTime ? new Date(item.lastMessageTime).getTime() : 0,
                                                    timeAgo: item.lastMessageTime ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$date$2d$fns$2f$formatDistanceToNow$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDistanceToNow"])(new Date(item.lastMessageTime), {
                                                        addSuffix: true
                                                    }) : 'N/A'
                                                })));
                                            ...
                                            return finalSortedItems.map((item)=>{
                                                ...
                                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    className: `p-4 border-b border-gray-100 cursor-pointer hover:bg-gray-50 transition-colors ${isSelected ? 'bg-teal-50 border-l-4 border-teal-600' : ''} ${unreadCount > 0 ? 'bg-blue-50' : ''}`,
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "flex items-center gap-3",
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        children: [
                                                                            ...
                                                                            item.lastMessageTime && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                className: "text-xs text-gray-500",
                                                                                children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$date$2d$fns$2f$formatDistanceToNow$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDistanceToNow"])(new Date(item.lastMessageTime), {
                                                                                    addSuffix: true
                                                                                })
                                                                            }, void 0, false, {
                                                                                fileName: "[project]/OneDrive/Desktop/mediwise/frontend/app/patient/chat/page.tsx",
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                        ...
                                                                        children: item.lastMessage || 'No messages yet'
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/OneDrive/Desktop/mediwise/frontend/app/patient/chat/page.tsx",
                                                                        lineNumber: 603,
                                                                        columnNumber: 27
                                                            ...
                                                            unreadCount > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                className: "bg-teal-600 text-white text-xs px-2 py-1 rounded-full font-bold",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "hidden lg:flex flex-1 flex-col bg-gray-50",
                                children: selectedConversation ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ("TURBOPACK compile-time value", "development") === 'development' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "text-xs text-gray-400 mb-2 p-2 bg-gray-100 rounded",
                                                    children: [
                                                        "Messages: ",
                                                        messages.length,
                                                        " | Conversation: ",
                                                ...
                                                messages.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                messages.map((message, index)=>{
                                                    ...
                                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: `max-w-xs lg:max-w-md px-4 py-2 rounded-2xl ${isOwn ? 'bg-teal-600 text-white' : 'bg-white text-gray-800 border border-gray-200'}`,
                                                            children: [
                                                                !isOwn && message.sender && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                    className: "text-xs font-semibold mb-1 opacity-75",
                                                                    children: message.sender.name || 'Unknown'
                                                                }, void 0, false, {
                                                                    fileName: "[project]/OneDrive/Desktop/mediwise/frontend/app/patient/chat/page.tsx",
                                                                    lineNumber: 674,
                                                                    columnNumber: 27
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                    ...
                                                                    children: message.content || '(empty message)'
                                                                }, void 0, false, {
                                                                    fileName: "[project]/OneDrive/Desktop/mediwise/frontend/app/patient/chat/page.tsx",
                                                                    lineNumber: 678,
                                                                    columnNumber: 25
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        isOwn && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                            ...
                                                                            children: message.isRead ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                ...
                                                                                lineNumber: 686,
                                                                                columnNumber: 33
                                                                            }, this) : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    ...
                                                    }, message.id || `msg-${index}-${message.createdAt}-${message.content?.substring(0, 10)}`, false, {
                                                        fileName: "[project]/OneDrive/Desktop/mediwise/frontend/app/patient/chat/page.tsx",
                                                        lineNumber: 662,
                                                        columnNumber: 21
                                                    }, this);
...
_s(PatientChatPage, "FWEQAX2uAiPG5tnLtnTRijPe71Y=", false, function() {
    return [
...
_c = PatientChatPage;
var _c;
__turbopack_context__.k.register(_c, "PatientChatPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=OneDrive_Desktop_mediwise_frontend_2b2c3f7e._.js.map