    ...
    const fetchDoctorProfile = async ()=>{
        try {
            ...
            if (response.data.doctor) {
                const doctor1 = response.data.doctor;
                setFormData({
                    departmentId: doctor1.departmentId || '',
                    specialization: doctor1.specialization || '',
                    experience: doctor1.experience?.toString() || '',
                    qualification: doctor1.qualification || '',
                    bio: doctor1.bio || '',
                    consultationFee: doctor1.consultationFee?.toString() || '',
                    availableFrom: doctor1.availableFrom || '',
                    availableTo: doctor1.availableTo || ''
                });
                // Ensure availableDays is an array
                let days = doctor1.availableDays;
                ...
                if (doctor1.profileImage) {
                    setProfileImagePreview(`data:${doctor1.profileImageMimeType || 'image/jpeg'};base64,${doctor1.profileImage}`);
                }
            }
...
_s(DoctorProfileEditPage, "IO/KUxVBnlNSZZLqCY5E/NEVIVY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$mediwise$2f$frontend$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
...
//# sourceMappingURL=OneDrive_Desktop_mediwise_frontend_5ed98819._.js.map